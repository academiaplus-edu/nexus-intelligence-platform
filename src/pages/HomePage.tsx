...
import { ArrowRight, BookOpen, Globe, TrendingUp, CheckCircle2, Star } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl space-y-8 animate-fade-in">
            ...
            <p className="text-xl text-slate-300 max-w-2xl leading-relaxed">
              Nexus Intelligence delivers deep-tech analysis and geopolitical reports that the mass market misses. Trusted by researchers and executives worldwide.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground max-w-xl">Freshly published insights from our global network of experts and academic fellows.</p>
          </div>
            ...
            <Card key={post.id} className="group flex flex-col hover:shadow-lg transition-shadow border-slate-200 dark:border-slate-800">
              <CardHeader className="space-y-4 flex-1">
                <div className="flex justify-between items-start">
                  <Badge variant="secondary" className="bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-slate-100">{post.category}</Badge>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  "Access proprietary statistical models and datasets",
                  "Receive early-bird alerts on regulatory shifts",
                  "Direct line to academic consultants for deep dives",
                  "Bi-weekly executive summary audio briefs"
                ].map((item, i) => (
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8 backdrop-blur-sm relative overflow-hidden group">
               ...
               <div className="relative space-y-6">
                 ...
                 <p className="text-xl italic text-slate-300">"Nexus has fundamentally changed how we evaluate political risk in the Indo-Pacific. The depth of their reports is unmatched by traditional consulting firms."</p>
                 <div className="flex items-center gap-4">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-slate-400">Head of Strategy, Global Logistics Inc.</p>
                   </div>
                 </div>
               </div>
            </div>
