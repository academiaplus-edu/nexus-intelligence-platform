import type { Brief, Service, PricingTier, User } from './types';
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Dr. Alan Grant', email: 'alan@nexus.edu', tier: 'Academic' },
  { id: 'u2', name: 'Sarah Connor', email: 'sarah@skynet.com', tier: 'Industry' }
];
export const MOCK_POSTS: Brief[] = [
  {
    id: "1",
